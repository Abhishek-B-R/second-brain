...
import { Search, Heart, TrendingUp, Clock, Sparkles, Loader2 } from "lucide-react"
...
export default function Home() {
  ...
  }, [searchTerm, filterType, sortBy, showFavoritesOnly])
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-12 text-center space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Discover, organize, and revisit your curated collection of insights from across the web. Powered by AI for
              intelligent content summarization and smart organization.
            </p>
          </div>

          {/* Enhanced Stats */}
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4 max-w-4xl mx-auto">
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-4 border border-white/20 shadow-lg">
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-4 border border-white/20 shadow-lg">
              <div className="text-2xl font-bold text-blue-500">{stats.twitter}</div>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="text-lg text-muted-foreground">
            Showing <span className="font-semibold text-foreground">{websites.length}</span> items
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {displayedWebsites.map((website) => (
            <div key={website._id} className="embed-container">
              <EnhancedWebsiteCard website={website} onToggleFavorite={handleToggleFavorite} onDelete={handleDelete} />
            </div>
          ))}
        </div>
        ...
        {hasMoreWebsites && (
          <div className="flex justify-center mt-12">
            <Button
              ...
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all duration-200 px-8 py-3"
            >
              {loadingMore ? (
                <>
          ...
          <div className="text-center py-20 space-y-6">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-semibold text-muted-foreground">
                {websites.length === 0 && !searchTerm && filterType === "all" && !showFavoritesOnly
                  ? "Your knowledge hub awaits"
                  : "No items found"}
              </h3>
              <p className="text-muted-foreground max-w-md mx-auto">
                {websites.length === 0 && !searchTerm && filterType === "all" && !showFavoritesOnly
                  ? "Start building your digital knowledge hub by adding your first website, YouTube video, or social media post"
